...
// ==========================================================
// CRITICAL FIX: Wait for the entire HTML to load before running any code
// ==========================================================
document.addEventListener('DOMContentLoaded', () => {
    ...
    function init() {
        // Initialize both parts of the application
        init3D();
        initBackground();
    ...
    function initBackground() {
        setCanvasSize();
        window.addEventListener('resize', setCanvasSize); // Ensure background also resizes
    }
    ...
    function animate() {
        ...
        TWEEN.update();
        animateBackground(); // Run the background animation within the main loop
